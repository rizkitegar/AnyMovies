...
/**
 * Blocking error state: icon, optional title, message, and an optional action button.
 * The message text must always come from `DomainError.toUserMessage()` at the call site —
